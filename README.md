...
### Taskmaster 5000 set to be released early next fall

# 1. points increment system
# 2. commenting on tasks or on group message board
# 3. groups system will be implemented
 ![screen1](https://i.imgur.com/FkVnvyy.png) 
